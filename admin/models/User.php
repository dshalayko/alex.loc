...
class User extends \admin\base\ActiveRecordData implements \yii\web\IdentityInterface {
    ...
    public function getDataSchema() {
        return [
            ...
            'fio' => ['title' =>  Yii::t('admin', 'ФИО (вин падеж)'), 'value' => ' '],
            'spetialnost' => ['title' =>  Yii::t('admin', 'Специальность'), 'value' => ' '],
            'dolshnost' => ['title' =>  Yii::t('admin', 'Должность'), 'value' => ' '],
            'adresovano' => ['title' =>  Yii::t('admin', 'Кому адпресовано письмо (род. падеж)'), 'value' => ' '],
            'dolshnost_adresata' => ['title' =>  Yii::t('admin', 'Должность адресата(род.падеж)'), 'value' => ' '],
            'universe' => ['title' =>  Yii::t('admin', 'Универститет'), 'value' => ' '],
            'shablon' => ['title' =>  Yii::t('admin', 'Шаблон'), 'value' => ' '],
